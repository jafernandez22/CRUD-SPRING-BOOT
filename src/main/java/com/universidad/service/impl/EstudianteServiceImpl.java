...
public class EstudianteServiceImpl implements IEstudianteService { // Define la clase EstudianteServiceImpl que implementa la interfaz IEstudianteService
    ...
    @Override
    public EstudianteDTO actualizarEstudiant(Long id, EstudianteDTO estudianteDTO){
        Estudiante estudiante = estudianteRepository.findById(id);
        if (estudiante == null) {
            return null;
        }
        ...
        //Guardar
        Estudiante estudianteactunuevo = estudianteRepository.save(estudiante);
        return convertToDTO(estudianteactunuevo);
    }

    //B crear  nuevo estudiante
    @Override
    public EstudianteDTO crearEstudiantenuv(EstudianteDTO estudianteDTO){
        Estudiante nuevoEst = convertToEntity(estudianteDTO);
        Estudiante estudiante = estudianteRepository.save(nuevoEst);
